...
Use these guides for the current v3.1.6 release line:
...
Current public screenshots live under `images/`. v3.1.6 does not introduce a
...
python -m pytest -q tests/test_comprehensive_readme.py \
  ...
  tests/test_v316_release_docs.py
```
