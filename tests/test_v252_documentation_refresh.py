"""Preserve historical v2.5.2 assets and validate current v3.1.5 docs."""
...
def test_current_docs_and_roadmap_exist():
    required = (
        ...
        "docs/releases/v3.1.5.md",
        "docs/roadmap.md",
        "docs/v3.1.5-qa-checklist.md",
        "docs/webui.md",
    )
